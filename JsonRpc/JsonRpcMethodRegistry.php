...
final class JsonRpcMethodRegistry
{
     ...
     *
     * @return non-empty-array<non-empty-string, class-string<JsonRpcRequest<non-empty-string>>>
     */
     ...
     *
     * @return non-empty-array<non-empty-string, class-string<JsonRpcNotification<non-empty-string>>>
     */
