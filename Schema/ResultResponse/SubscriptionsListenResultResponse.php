 ...
 *
 * @property-read SubscriptionsListenResult $result
 *
...
{
    public function __construct(RequestId $id, SubscriptionsListenResult $result)
    {
    ...
    public static function fromArray(array $data): static
    {
        ...
        return new self(id: $id, result: SubscriptionsListenResult::fromArray($payload));
    }
